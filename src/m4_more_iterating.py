...
def run_test_count_items_bigger_than():
    ...
    # Test 10:
    sequence = [14, 92, 17, 76, 18, 12, 19, 14, 39, 41, 45]
    threshold = 21
    expected = 5
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 3
    actual = count_positive_sines([1, 9, 6, 3])
    print()
    print('Test 6 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # Test 9:
    expected = 18
    actual = sum_first_n([18, 12, -6, 4, -10, 22, 17], 5)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
